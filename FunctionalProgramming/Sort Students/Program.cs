namespace FunctionalProgramming
{
    ...
    class Program
    {
        ...
        static void Main()
        {
            ...
            helper.ConsoleMio.PrintHeading("Sort Students ");
            ...
            var extractedStudents = students
                .OrderByDescending(student => student.FirstName, StringComparer.Ordinal)
                .ThenByDescending(student => student.LastName, StringComparer.Ordinal);
